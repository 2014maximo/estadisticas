...
export const CHANCES: GrupoModel[] = [
    {
        ...
        grupos: [
            ...
            { campo:'cifra uno', tipo:'text', ancho:'40', maxlength:'1', minlength:'', nombreCampo:'cifra_1', clase:STYLO_UNO},
            { campo:'cifra dos', tipo:'text', ancho:'40', maxlength:'1', minlength:'', nombreCampo:'cifra_2', clase:STYLO_UNO},
            { campo:'cifra tres', tipo:'text', ancho:'40', maxlength:'1', minlength:'', nombreCampo:'cifra_3', clase:STYLO_UNO},
            { campo:'cifra cuatro', tipo:'text', ancho:'40', maxlength:'1', minlength:'', nombreCampo:'cifra_4', clase:STYLO_UNO},
        ...
        formulario: new FormGroup({
            ...
            cifra_1: new FormControl({ value: '', disabled: false }, Validators.required),
            cifra_2: new FormControl({ value: '', disabled: false }, Validators.required),
            cifra_3: new FormControl({ value: '', disabled: false }, Validators.required),
            cifra_4: new FormControl({ value: '', disabled: false }, Validators.required),
